...
if AC_TRY_COMMAND([$GHC $GHCFLAGS $GHCLDFLAGS -o conftest conftest.hs $GHCLIBS >&AS_MESSAGE_LOG_FD 2>&AS_MESSAGE_LOG_FD]) && test -s conftest
then
...
ifelse([$3], , , [ rm -f Main.hi Main.o conftest
  $3
])dnl
fi])
